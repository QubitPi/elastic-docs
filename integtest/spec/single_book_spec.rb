      ...
      page_context 'index.html' do
        ...
        it 'has a link to the css' do
          expect(head).to include(<<~HTML)
            <link rel="stylesheet" type="text/css" href="/QubitPi/elastic-docs/guide/static/styles-v1.css" />
          HTML
        end
        it 'has a link to the js' do
          expect(contents).to include(<<~HTML)
            <script type="text/javascript" src="/QubitPi/elastic-docs/guide/static/docs-v1.js"></script>
          HTML
        end
