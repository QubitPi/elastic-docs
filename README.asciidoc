...
They are currently hosted at https://github.com/QubitPi/QubitPi/tree/gh-pages/elastic-docs/guide/static[my profile repo]

To update those static resources manually, use the following command and copy & paste the contents from Docker container
to https://github.com/QubitPi/QubitPi/tree/gh-pages/elastic-docs/guide/static[host server] or simply download it from
container's running http://localhost:8000
